$(document).ready(function() {
    ...
    function getItemName($deleteBtn) {
        ...
        var $card = $deleteBtn.closest('.menu-item-card');
    ...
    function getConfirmMessage(itemName) {
        console.log('Window translations:', window.menuTranslations); // Debug log
        console.log('Item name:', itemName); // Debug log
        
        // Try to get localized message with item name from window translations
        if (window.menuTranslations && window.menuTranslations.confirm_delete_item) {
            var message = window.menuTranslations.confirm_delete_item.replace(':name', itemName);
        ...
        if (window.menuTranslations && window.menuTranslations.confirm_delete) {
            var message = window.menuTranslations.confirm_delete;
     ...
     */
    function deleteMenuItem(itemId, $deleteBtn) {
        // Show loading state
        ...
        $.ajax({
            url: '/admin/menu/delete/' + itemId + '?locale=' + currentLocale,
            type: 'DELETE',
            headers: {
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    var $item = $deleteBtn.closest('tr, .menu-item-card');
    ...
    function getLocalizedMessage(key) {
        ...
        if (window.menuTranslations && window.menuTranslations[key]) {
            return window.menuTranslations[key];
        }
